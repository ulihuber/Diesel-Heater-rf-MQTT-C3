...
#define HEATER_SS_PIN    7
#define HEATER_GDO2_PIN  10
*/
...
const char stateList[9][20] = { "Off", "Startup", "Warming", "Warming Wait", "Pre-Run", "Running", "Shutdown", "Shutting Down", "Cooling" };  


#define HEATER_ERROR_NO_ERROR       0x00
#define HEATER_ERROR_OVERVOLTAGE    0x01
#define HEATER_ERROR_UNDERVOLTAGE   0x02
#define HEATER_ERROR_GLOWPLUG       0x03
#define HEATER_ERROR_PUMP           0x04
#define HEATER_ERROR_OVERHEAT       0x05
#define HEATER_ERROR_MOTOR          0x06
#define HEATER_ERROR_BROKENLINE     0x07
#define HEATER_ERROR_FLAME          0x08
const char errorList[9][20] = { "No Error", "Overvoltage", "Undervoltage", "Glowplug", "Pump", "Overheat", "Motor", "Broken Line", "Flame" };
...
class DieselHeaterRF
{
    ...
    public:
        ...
        bool getState(uint8_t *state, uint8_t *power, uint8_t *error, float *voltage, int8_t *ambientTemp, uint8_t *caseTemp, int8_t *setpoint, float *pumpFreq, uint8_t *autoMode, int16_t *rssi, uint32_t timeout);
